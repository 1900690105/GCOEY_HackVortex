...
//             {state === 3 && (
//               <div>
//                 <p className="text-lg font-bold">Summary of you learn</p>
...
//             {state === 4 && (
//               <div>
//                 <p className="text-lg font-bold">Communication skills</p>
//                 <p className="text-base font-bold">Active Listening</p>
//                 <span>
