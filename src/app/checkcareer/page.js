...
const page = () => {
  ...
  useEffect(() => {
    ...
    const assisment_result = localStorage.getItem("assisment_result");
    ...
    if (assisment_result) {
      setFinalize(JSON.parse(assisment_result));
    }
  }, []);
  ...
  passion_conclusion : ${assessment_1.conclusion},profession_conclusion : ${assessment_2.conclusion},vocation_conclusion : ${assessment_3.conclusion},mission_conclusion : ${assessment_4.conclusion},]`;
    try {
      ...
      const json = JSON.parse(text);
      setFinalize(json);
      localStorage.setItem("assisment_result", JSON.stringify(json));
      console.log(json);
    } catch (error) {
      console.error(error);
    } finally {
          ...
          {finalize && (
            <div className="bg-blue-50 rounded-lg p-6 shadow-sm max-w-2xl mx-auto">
              ...
              <div className="space-y-4">
                ...
                <p>
                  Before making any decision, consider taking practical
                  assessments first,and knowldge people in that field
                </p>
                <div className="flex gap-2 justify-center">
                  <Button
                    ...
                    className="w-24 bg-blue-600 text-white px-8 py-3 text-lg hover:bg-blue-700"
                  >
                    Start Here
                  </Button>
                </div>
